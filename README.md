...
6. **[`theory.md`](./theory.md)** — Теоретические основы работы ТСПУ/DPI, подробное описание принципов обхода блокировок и анализ причин сбоев каждого метода.не шифрует остальной трафик.
* **Для полного VPN:** Клиент **NekoBox** или **v2rayN** с подключением к вашему серверу [VLESS (Remnawave)](./vless/) или [Hysteria 2](./hysteria2/).
